...
function initMarqueeScroll() {
  ...
  window.addEventListener("wheel", (e) => {
    ...
    // deltaY > 0 = scroll down → right-to-left (negative, reversed)
    // deltaY < 0 = scroll up  → left-to-right (positive, default)
  ...
  function tick() {
    // Very slow decay so direction reversal after scroll-stop is gradual, not jarring
    targetVel += (0.5 - targetVel) * 0.006;
